                                ...
                                <table class="table table-striped table-bordered table-list table-list-search" style="margin: 0px;">
                                    <thead>
                                        <tr>                            
                                            ...
                                            <th class="col-text">Sexo</th>
                                            <th class="col-text">Fecha de Nacimiento</th>
                                            <th class="col-text text-center">Teléfono</th>
                                            <th class="col-text text-center">Email</th>
                                            <th class="col-text text-center">Opciones</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="row" items="${lista}">                                            
                                            <tr>                                                                                            
                                                <td><c:out value="${row.perRut}"/>-<c:out value="${row.perDv}"/></td>
                                                <td><c:out value="${row.perNombreCompleto}"/></td>
                                                <td><c:out value="${row.perSexo}"/></td>
                                                <td><c:out value="${row.perFechaNacimiento}"/></td>
                                                <td><c:out value="${row.perTelefono}"/></td>
                                                <td><c:out value="${row.perEmail}"/></td>                                                
                                                <td align="center">
                                                    <a class="btn btn-info btn-sm" href="personaParamsModificar?rut=<c:out value='${row.perRut}'/>"><span class="glyphicon glyphicon-pencil" ></span></a>
                                                    <a class="btn btn-danger btn-sm" href="personaBorrar?rut=<c:out value='${row.perRut}'/>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                                </td>                                            
                                        </tr>                                                                              
                                        </c:forEach>
                                    </tbody>
