                ...
                <form action="${pageContext.request.contextPath}/ingresarPaciente" method="GET" id="personaForm">            
                    <div class="row">
                        <div class="col-xs-6 col-md-6">
                            <input class="form-control" type="text" name="personaRut" placeholder="Rut" required/>
                        </div>
                    ...
                    <input class="form-control" type="text" name="personaEmail" placeholder="Email"/>
                    <button class="btn btn-lg btn-primary btn-block" type="submit">Ingresar Paciente</button> 
                </form>
