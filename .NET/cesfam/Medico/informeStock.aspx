<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="informeStock.aspx.cs" Inherits="cesfam.Medico.informeStock" %>
            ...
            <div class="row content">
                ...
                <h3>Informe de Stock</h3>
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                        ...
                        DataSourceID="SqlDataSourceStock" CssClass="table table-hover table-striped">
                        <Columns>
                            <asp:BoundField DataField="MED_NOMBRE" HeaderText="Medicamento" ReadOnly="True" 
                                SortExpression="MED_NOMBRE" />
                            <asp:BoundField DataField="MED_STOCK" HeaderText="Stock" ReadOnly="True" 
                                SortExpression="MED_STOCK" />
                            <asp:BoundField DataField="MED_RESERVADO" HeaderText="En Reserva" 
                                ReadOnly="True" SortExpression="MED_RESERVADO" />
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceStock" runat="server" 
                        ...
                        SelectCommand="SELECT &quot;MED_NOMBRE&quot;, &quot;MED_RESERVADO&quot;, &quot;MED_STOCK&quot; FROM &quot;CES_MEDICAMENTO&quot;">
                    </asp:SqlDataSource>
