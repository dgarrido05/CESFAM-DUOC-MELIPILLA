...
<div class="container-fluid">
    ...
    <div class="col-sm-10 text-left"> 
      <h1>Modificar Paciente</h1>                
                <div class="col-sm-8 col-md-4 well well-sm ">
                <form action="${pageContext.request.contextPath}/usuarioModificar" method="POST" id="personaForm">
                    
                    <div class="row">
                        <div class="col-xs-8 col-md-8 " style="padding-right: 5px;">
                            <input class="form-control" type="text" name="personaRut" value="<c:out value='${lista.cesPersonaPerRut}'/>" required autofocus readonly/>
                        </div>                        
                    </div>                    
                    <input class="form-control" type="text" name="personaNombre" value="${lista.usuNombreUsuario}"/>               
                    <input class="form-control" type="text" name="personaApPaterno" placeholder="Nueva contraseña"/>
